...
namespace tipo.Controllers
{
    public class AcudientesController : Controller
    {
        ...
        public AcudientesController(tipoContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("AcudienteID,Nombre,Apellido,FechaNacimiento,Telefono")] Acudiente acudiente)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("AcudienteID,Nombre,Apellido,FechaNacimiento,Telefono")] Acudiente acudiente)
        {
