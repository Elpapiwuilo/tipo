...
namespace tipo.Controllers
{
    public class EstudiantesController : Controller
    {
        ...
        public EstudiantesController(tipoContext context)
        {
            _context = context;
        }
        ...
        {
            var tipoContext = _context.Estudiante.Include(e => e.Acudiente);
            return View(await tipoContext.ToListAsync());
        }
        ...
        public async Task<IActionResult> Create([Bind("EstudianteID,AcudienteID,Nombre,Apellido,edad")] Estudiante estudiante)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("EstudianteID,AcudienteID,Nombre,Apellido,edad")] Estudiante estudiante)
        {
